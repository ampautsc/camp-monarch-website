...
const groups: NavGroup[] = [
    ...
    sections: [
      ...
      },
      {
        ...
        items: [
          ...
          { id: 'american-beech',        label: 'American Beech' },
          { id: 'shagbark-hickory',      label: 'Shagbark Hickory' },
          { id: 'red-maple',             label: 'Red Maple' },
        ],
      },
    ],
  },
  ...
  },
  {
    ...
    children: [
      ...
      { id: 'habitat-layers',         label: 'The Four Habitat Layers' },
