...
const PHOTO_FALLBACK =
  'data:image/svg+xml;utf8,<svg xmlns="http://www.w3.org/2000/svg" width="960" height="540"><rect width="100%" height="100%" fill="%23e8f5e9"/><text x="50%" y="50%" dominant-baseline="middle" text-anchor="middle" font-size="48" fill="%234caf50">33f</text></svg>'
...
const SPECIES: Species[] = [
  ...
  },
  {
    ...
    emoji: '426',
    shortDesc: 'Builds one of North America's most intricate nests: a woven hanging pouch suspended from the drooping tips of tall trees. Dutch elm disease removed millions of the branch structures it once preferred. The population has fallen 24 percent since 1966.',
    status: 'declining',
    photo: 'https://upload.wikimedia.org/wikipedia/commons/f/f5/Baltimore_Oriole-_dorsum.jpg',
    photoCredit: 'TonyCastro / CC BY-SA 4.0',
  ...
  },
  {
    ...
    emoji: '426',
    shortDesc: 'Arrives crimson in May, then molts olive-green before crossing 600 miles of Gulf water on stored fat. Breeding success collapses in forest patches under 10 hectares because cowbird parasitism can reach 60 to 80 percent. The population has fallen 38 percent since 1966.',
    status: 'declining',
