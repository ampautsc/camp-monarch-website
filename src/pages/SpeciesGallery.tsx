...
emoji: '🦋',
  ...
  },
  {
    ...
    emoji: '🦋',
    photo: 'https://inaturalist-open-data.s3.amazonaws.com/photos/25798530/large.jpeg',
    photoCredit: 'raymackie / iNaturalist · CC BY-NC',
    page: 'eastern-tailed-blue' as Page,
    status: 'stable' as const,
    habitatTags: ['clover-lawn', 'open-meadow', 'legume-garden'],
    shortDesc: "The Eastern Tailed-Blue's hindwing ends in a thin tail that rises like an antenna when it perches, with an orange spot beside it completing a false head. Late-season wild specimens are missing those tails far more often than any other wing section — attacks land at the tail end, not at the body.",
  },
  {
    id: 'gray-hairstreak',
    ...
    emoji: '🦋',
    photo: 'https://inaturalist-open-data.s3.amazonaws.com/photos/382627539/large.jpg',
    photoCredit: 'dhasdf / CC BY via iNaturalist',
    page: 'gray-hairstreak' as Page,
    status: 'stable' as const,
    habitatTags: ['legume-garden', 'mallow-bed', 'clover-lawn'],
    shortDesc: 'When a Gray Hairstreak lands and closes its wings, it pumps its hindwings back and forth — two white-tipped tails at the rear corner oscillate like antennae against an orange-capped spot — and any predator that strikes at the apparent head takes a fragment of detachable wing tissue while the butterfly continues flying.',
  },
  {
    id: 'sleepy-orange',
    name: 'Sleepy Orange',
