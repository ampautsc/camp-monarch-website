    ...
    <>
      ...
      <div className="page">
        ...
        <div className="action-panel">
          <h2 style={{ marginTop: 0 }}>A brush pile, leaf litter under shrubs, dense native shrubs, and a 1.5-inch nest box</h2>
        ...
        <section aria-labelledby="connection-heading">
          ...
          <p>
            ...
            {' '}starts each trunk at the base and spirals upward, pressing its bill into bark
            furrows to extract the same beetle larvae and spider eggs the wren takes from fallen
            logs and brush piles at ground level. Both species work dead wood through winter —
            the creeper on vertical bark, the wren in the brush and on the litter floor. A yard
            with rough-barked native trees, standing dead snags, and brush at the base feeds both
            on the same overwintering invertebrate community.
          </p>
        </section>
