  ...
  return (
    <>
      ...
      <div className="page">
        ...
        {/* MEET YOUR NEIGHBORS — preview the species gallery; routes homepage traffic to 40 species pages */}
        <section aria-labelledby="neighbors-heading" style={{ marginTop: '2.5rem' }}>
          ...
          <p style={{ color: 'var(--text-secondary)', marginBottom: '1.25rem' }}>
            40 species depend on backyards, gardens, and the choices homeowners make about their land.
