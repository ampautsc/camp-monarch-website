...
type SeasonalItem = { emoji: string; label: string; detail: string }
  ...
  return (
    <>
      ...
      <div className="page">
        ...
        {/* Story — individual over species. Move to section 2 so visitors reach it (www-011). */}
        ...
        {/* Seasonal right-now panel — 2 items (bta-004, bta-005, lesson-044) */}
        ...
        {/* Three ways to help — replaces "What Camp Monarch does" + "Start this week" + "Migration passes your yard" */}
        {/* Named, specific, low friction (bta-004). One primary CTA per card. */}
        <section aria-labelledby="help-heading" style={{ marginTop: '2.5rem' }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(220px, 1fr))', gap: '1.25rem', marginTop: '1rem' }}>
            ...
            <div className="fact-card" style={{ display: 'flex', flexDirection: 'column', alignItems: 'flex-start', padding: '1.25rem' }}>
        ...
        {/* Witnesses — first-person voices (bta-002, bta-003). 2 cards — enough signal without over-proving. */}
